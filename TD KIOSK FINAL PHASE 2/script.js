...
function _wrapPreviewHtmlAsDocument(innerHtml, cssText) {
    var docCss =
        ...
        'body { font-family: Inter, "Segoe UI", Roboto, system-ui, sans-serif; display: flex; justify-content: center; align-items: flex-start; }' +
        ...
        '.report-preview-container.report-pdf-compact { width: 210mm !important; max-width: 210mm !important; min-height: auto !important; max-height: none !important; padding: 14mm 12mm !important; margin: 0 auto !important; box-shadow: none !important; font-size: 12pt !important; line-height: 1.45 !important; }' +
        '.report-preview-container.report-pdf-compact h1 { font-size: 18pt !important; margin: 2px 0 6px !important; text-align: center !important; }' +
        '.report-preview-container.report-pdf-compact h2 { font-size: 13pt !important; margin: 2px 0 6px !important; text-align: center !important; }' +
        '.report-preview-container.report-pdf-compact h3 { font-size: 12pt !important; margin: 8px 0 4px !important; }' +
        '.report-preview-container.report-pdf-compact table { margin: 6px 0 !important; }' +
        '.report-preview-container.report-pdf-compact th, .report-preview-container.report-pdf-compact td { padding: 4px 6px !important; font-size: 11pt !important; border-width: 1px !important; }' +
        '.report-preview-container.report-pdf-compact .report-remarks-box { min-height: 24px !important; padding: 4px 6px !important; margin: 6px 0 !important; }' +
        '.report-preview-container.report-pdf-compact .report-approval-table { margin-top: 8px !important; }' +
...
function populateReportPreview(preview) {
    ...
    var totalDrops = derived.totalDrops != null ? derived.totalDrops : derived.totalTaps;
    var totalDropsStr = totalDrops != null ? String(totalDrops) : 'N/A';
    setReportEl('report-total-taps', totalDropsStr);
    var tapCountBody = document.getElementById('report-tap-count-rows');
    if (tapCountBody) {
        var tapRows = '';
        var stc = derived.stepDropCounts || derived.stepTapCounts || [];
        for (var ti = 0; ti < stc.length; ti++) {
            tapRows += '<tr><th>DROP COUNT ' + (ti + 1) + '</th><td colspan="3">' + stc[ti] + '</td></tr>';
        }
    ...
    setReportEl('report-total-drops', totalDrops != null ? String(totalDrops) : '--');
